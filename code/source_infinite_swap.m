...
rho = @(x1,x2,beta1,beta2) exp((post(x1)/beta1)+(post(x2)/beta2))/(exp((post(x1)/beta1)+(post(x2)/beta2))+exp((post(x2)/beta1)+(post(x1)/beta2)));
...
sigma_rwm=[0.005,0.1];%*linspace(1,100,N_temp);
